...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        frame_numbers = new QFrame(centralWidget);
        frame_numbers->setObjectName(QString::fromUtf8("frame_numbers"));
        frame_numbers->setGeometry(QRect(570, 10, 431, 441));
        frame_numbers->setFrameShape(QFrame::StyledPanel);
        frame_numbers->setFrameShadow(QFrame::Plain);
        pushButton_n1 = new QPushButton(frame_numbers);
        pushButton_n1->setObjectName(QString::fromUtf8("pushButton_n1"));
        pushButton_n1->setGeometry(QRect(10, 10, 100, 90));
        pushButton_n2 = new QPushButton(frame_numbers);
        pushButton_n2->setObjectName(QString::fromUtf8("pushButton_n2"));
        pushButton_n2->setGeometry(QRect(120, 10, 100, 90));
        pushButton_n3 = new QPushButton(frame_numbers);
        pushButton_n3->setObjectName(QString::fromUtf8("pushButton_n3"));
        pushButton_n3->setGeometry(QRect(230, 10, 100, 90));
        pushButton_n4 = new QPushButton(frame_numbers);
        pushButton_n4->setObjectName(QString::fromUtf8("pushButton_n4"));
        pushButton_n4->setGeometry(QRect(10, 110, 100, 90));
        pushButton_n5 = new QPushButton(frame_numbers);
        pushButton_n5->setObjectName(QString::fromUtf8("pushButton_n5"));
        pushButton_n5->setGeometry(QRect(120, 110, 100, 90));
        pushButton_n6 = new QPushButton(frame_numbers);
        pushButton_n6->setObjectName(QString::fromUtf8("pushButton_n6"));
        pushButton_n6->setGeometry(QRect(230, 110, 100, 90));
        pushButton_n7 = new QPushButton(frame_numbers);
        pushButton_n7->setObjectName(QString::fromUtf8("pushButton_n7"));
        pushButton_n7->setGeometry(QRect(10, 210, 100, 90));
        pushButton_n8 = new QPushButton(frame_numbers);
        pushButton_n8->setObjectName(QString::fromUtf8("pushButton_n8"));
        pushButton_n8->setGeometry(QRect(120, 210, 100, 90));
        pushButton_n9 = new QPushButton(frame_numbers);
        pushButton_n9->setObjectName(QString::fromUtf8("pushButton_n9"));
        pushButton_n9->setGeometry(QRect(230, 210, 100, 90));
        pushButton_n11 = new QPushButton(frame_numbers);
        pushButton_n11->setObjectName(QString::fromUtf8("pushButton_n11"));
        pushButton_n11->setGeometry(QRect(10, 310, 100, 90));
        pushButton_n0 = new QPushButton(frame_numbers);
        pushButton_n0->setObjectName(QString::fromUtf8("pushButton_n0"));
        pushButton_n0->setGeometry(QRect(120, 310, 100, 90));
        pushButton_n12 = new QPushButton(frame_numbers);
        pushButton_n12->setObjectName(QString::fromUtf8("pushButton_n12"));
        pushButton_n12->setGeometry(QRect(230, 310, 100, 90));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_n4->setText(QApplication::translate("MainWindow", "4", nullptr));
        pushButton_n5->setText(QApplication::translate("MainWindow", "5", nullptr));
        pushButton_n6->setText(QApplication::translate("MainWindow", "6", nullptr));
        pushButton_n7->setText(QApplication::translate("MainWindow", "7", nullptr));
        pushButton_n8->setText(QApplication::translate("MainWindow", "8", nullptr));
        pushButton_n9->setText(QApplication::translate("MainWindow", "9", nullptr));
