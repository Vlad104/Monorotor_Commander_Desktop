...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMinimumSize(QSize(690, 540));
        MainWindow->setMaximumSize(QSize(690, 540));
        QFont font;
        ...
        frame_transmit->setGeometry(QRect(10, 390, 671, 91));
        ...
        pushButton_stop->setGeometry(QRect(10, 10, 121, 23));
        QFont font4;
        ...
        pushButton_continues->setGeometry(QRect(170, 10, 111, 23));
        pushButton_continues->setFont(font4);
        ...
        pushButton_singleStart->setGeometry(QRect(300, 10, 121, 23));
        pushButton_start = new QPushButton(frame_transmit);
        pushButton_start->setObjectName(QString::fromUtf8("pushButton_start"));
        pushButton_start->setEnabled(false);
        pushButton_start->setGeometry(QRect(460, 10, 121, 23));
        ...
        pushButton_continues_pressed->setGeometry(QRect(170, 40, 111, 23));
        pushButton_continues_pressed->setFont(font4);
